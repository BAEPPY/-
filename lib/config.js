...
export function getConfig() {
  ...
  return {
    ...
    english: {
      file: env.ENGLISH_WORDLIST?.trim() || path.join(ROOT, 'data', 'english-words.txt'),
      url: env.ENGLISH_WORDLIST_URL?.trim() || undefined,
      download: truthy(env.ENGLISH_DOWNLOAD, true),
    },
  };
}
